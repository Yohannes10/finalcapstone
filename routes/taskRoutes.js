...
// GET request to get all tasks (only accessible to admins)
router.get("/", authenticateAdminMiddleware, taskController.getAllTasks);
...
// GET request to get the rating summary
router.get("/ratings", authenticateUserMiddleware, taskController.getRatingSummary);
